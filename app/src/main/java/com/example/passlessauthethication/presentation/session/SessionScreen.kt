...
fun SessionScreen(
    ...
    LaunchedEffect(Unit) {
        viewModel.events.collect { event ->
            when (event) {
                is SessionEvent.LogoutSuccess -> onLogout()
            ...
            Column(
                ...
                Card(
                    ...
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            ...
                            Text(
                                text = formatDateTime(uiState.sessionStartTime),
                                style = MaterialTheme.typography.bodyLarge,
                                fontWeight = FontWeight.Medium,
                                color = MaterialTheme.colorScheme.onSurface
                            )
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = formatDuration(uiState.currentDuration),
                ...
                Card(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Your session is secure and will remain active until you logout.",
                            style = MaterialTheme.typography.bodySmall,
